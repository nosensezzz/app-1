				...
				React.createElement("div", {className: "user-register-div"}, 
					React.createElement("div", {className: "user-register-form"}, 
						...
						React.createElement("form", {onSubmit: this.saveAndContinue, role: "form"}, 
							...
							React.createElement("div", {className: "form-group"}, 
								React.createElement("label", {for: "ConfirmPassword"}, "ConfirmPassword:"), 
								React.createElement("input", {type: "password", ref: "confirmPassword", onChange: this.handleConfirmPasswordInput, value: this.state.confirmPassword, className: "form-control"})
							), 
							React.createElement("div", {style: hintStyle, id: "register-invalid-msg-div"}, "jjj"), 
						
							React.createElement("button", {type: "submit", className: "btn btn-default full-width"}, "Submit"), 
							React.createElement("button", {className: "btn =btn-default full-width", onClick: this.backToShell}, "Back")
						)
