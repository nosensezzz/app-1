		...
		render: function () {
			...
			return (
				React.createElement("div", {id: "dotahero-list-div", className: "module-main-div positionRelative"}, 
					...
					React.createElement("div", {id: "leftComponent", className: "hero-left-bar positionAbsolute"}, 
						React.createElement("div", {className: "clearboth", id: "hero-left-bar-content"}, "leftbar")
					), 

					React.createElement("button", {className: "positionAbsolute hero-bar-collapsed-i", onClick: self.leftBarControl}, "bar")
				)
				);
		}
	});
