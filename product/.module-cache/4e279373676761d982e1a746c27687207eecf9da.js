	...
	var DotaheroList = React.createClass({displayName: "DotaheroList",
		...
		filterControl: function (e) {
			...
			if(self.state.filter){
				self.state.filterComponent.addClass("hero-left-bar-hide");
				self.state.filterComponent.removeClass("hero-left-bar");
				self.state.listComponent.addClass("hero-right-content-full");
				self.state.listComponent.removeClass("hero-right-content");
				...
				self.state.filterComponent.removeClass("hero-left-bar-hide");
				self.state.filterComponent.addClass("hero-left-bar");
				self.state.listComponent.removeClass("hero-right-content-full");
				self.state.listComponent.addClass("hero-right-content");
				self.setState({
					filter:true
				});
