							...
							return React.createElement("div", {className: "item col-xs-4 col-lg-4 grid-group-item", key: hero.id, onClick: self.heroClicked.bind(self,hero)}, 
										React.createElement("div", {className: "thumbnail"}, 
											...
											React.createElement("div", {className: "row text-center"}, 
												React.createElement("div", {className: "col-xs-12 col-md-6 positionRelative"}, 
													React.createElement("img", {className: "smallIcon40 positionFixed", src: "build/picture/dotahero/basicIcons/overviewicon_primary.png", alt: true})
												), 
												React.createElement("div", {className: "col-xs-12 col-md-6"}, 
													React.createElement("img", {className: "smallIcon33 positionFixed", src: "build/picture/dotahero/basicIcons/overviewicon_int.png", alt: true})
												), 
