						...
						self.props.data.heroLocalData.map(function (hero) {
							return React.createElement("div", {className: "item col-xs-4 col-lg-4 grid-group-item", key: hero.id, onClick: self.heroClicked.bind(self,hero)}, 
										React.createElement("div", {className: "thumbnail"}, 
											...
											React.createElement("div", {className: "row text-center positionRelative"}, 
												React.createElement("div", {className: "col-xs-12 col-md-6 positionFixed"}, 
													React.createElement("img", {className: "smallIcon40", src: "build/picture/dotahero/basicIcons/overviewicon_primary.png", alt: true})
												), 
												React.createElement("div", {className: "col-xs-12 col-md-6 positionFixed"}, 
