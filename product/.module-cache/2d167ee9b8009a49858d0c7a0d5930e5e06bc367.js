				...
				React.createElement("div", {className: "user-login-div"}, 
					React.createElement("div", {className: "user-login-form"}, 
						...
						React.createElement("form", {onSubmit: this.saveAndContinue}, 
							React.createElement("input", {ref: "name", type: "text", value: this.state.email, onChange: this.handleEmailInput}), 
							...
							React.createElement("br", null), 
							React.createElement("button", {type: "submit", onClick: "{this.saveAndContinue}"}, "Submit")
						)
					)
				)
				);
