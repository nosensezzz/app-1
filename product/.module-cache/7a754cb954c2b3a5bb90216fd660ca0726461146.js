			...
			return (
				React.createElement("div", {id: "dotahero-summary-div", className: "module-main-div"}, 
					React.createElement("div", {className: "container full-size"}, 
						...
						React.createElement(IconType, {icon: "build/picture/dotahero/basicIcons/overviewicon_str.png"}), 
						React.createElement("div", {className: "row hero-summary-row-div"}, 
							React.createElement("span", {className: "col-xs-4 full-height hero-summary-row-div-span-forIcon"}, 
								React.createElement("img", {className: "hero-summary-row-div-icon", src: "build/picture/dotahero/basicIcons/overviewicon_agi.png"})
							), 
							React.createElement("span", {className: "col-xs-4"}, hero.startAgi, " + ", hero.AgiPerLv)
		
						), 
						React.createElement("div", {className: "row hero-summary-row-div"}, 
							React.createElement("span", {className: "col-xs-4 full-height hero-summary-row-div-span-forIcon"}, 
								React.createElement("img", {className: "hero-summary-row-div-icon", src: "build/picture/dotahero/basicIcons/overviewicon_int.png"})
							), 
							React.createElement("span", {className: "col-xs-4"}, hero.startInt, " + ", hero.IntPerLv)
						), 
						React.createElement("div", {className: "row hero-summary-row-div"}, 
							React.createElement("span", {className: "col-xs-4 full-height hero-summary-row-div-span-forIcon"}, 
								React.createElement("img", {className: "hero-summary-row-div-icon", src: "build/picture/dotahero/basicIcons/overviewicon_attack.png"})
							), 
							React.createElement("span", {className: "col-xs-4"}, hero.minDmgLv1 + " - " + hero.maxDmgLv1)
						), 
						React.createElement("div", {className: "row hero-summary-row-div"}, 
							React.createElement("span", {className: "col-xs-4 full-height hero-summary-row-div-span-forIcon"}, 
								React.createElement("img", {className: "hero-summary-row-div-icon", src: "build/picture/dotahero/basicIcons/overviewicon_armor.png"})
							), 
							React.createElement("span", {className: "col-xs-4"}, hero.armor)
						), 
						React.createElement("div", {className: "row hero-summary-row-div"}, 
							React.createElement("span", {className: "col-xs-4 full-height hero-summary-row-div-span-forIcon"}, 
								React.createElement("img", {className: "hero-summary-row-div-icon", src: "build/picture/dotahero/basicIcons/overviewicon_speed.png"})
							), 
							React.createElement("span", {className: "col-xs-4"}, hero.speed)
						), 
